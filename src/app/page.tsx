...
export default function  IndexApp() {
            ...
            <main id="indexApp">
                <div id="centerContent" className="flex flex-1 mb-10 items-center space-y-4 flex-nowrap flex-col">
                    <h1 id="title" className="text-8xl scroll-mt-20 snap-start">Cat Corp LLC</h1>
                    <h2 id="subtitle" className="text-2xl">Number One Cat based Software Firm</h2>
                    <Image id="img1" className="img w-full h-[60rem] scroll-mt-20 snap-center" alt="Cat working on Computer" src={businessCatInOffice}></Image>
                    <p className="centerText imgDesc text-4xl" id="main">We provide many different services and can help you.</p>
                    <p className="centerText imgTitle text-6xl scroll-mt-20 snap-start" id="stats">Our customers see an average of:</p>
                    ...
                    <p className="centerText imgTitle text-6xl scroll-mt-20 snap-start" id="thumbsuptext">Contact Us Today for a Free quote</p>
