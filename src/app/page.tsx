...
export default function  IndexApp() {
            ...
            <main id="indexApp">
                <div id="centerContent">
                    ...
                    <Image id="img1" className="img"  height= {500} width = {1000}  alt="Cat working on Computer"  src={businessCatInOffice}></Image>
                    ...
                    <Image id="img2" className="img"  height= {500} width = {1000}  alt="Graph. The Information of the Graph is described as"  src={dataGraphImg}></Image>
                    ...
                    <Image id="img4"  className="img" height= {500} width = {1000} src={happyCustomerThumbsUp} alt="Happy Customers Giving A Thumbs Up"></Image>
                </div>
            </main>
        )
